...
#else
	void var2val(const Variant&, Value&, int=0, bool=false)|?variant_to_value@core@@YAXAAUtagVARIANT@@AAVGenericValue@1@H_N@Z|?variant_to_value@core@@YAXAEAUtagVARIANT@@AEAVGenericValue@1@H_N@Z
#endif
...
:global
:dlls Dbghelp.dll
	uint UnDecorateSymbolName(int_ptr mangled, int_ptr demangled, uint len, uint flags)|UnDecorateSymbolNameW
